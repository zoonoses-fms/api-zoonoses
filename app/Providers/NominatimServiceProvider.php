 ...
 */
final class NominatimServiceProvider extends AbstractHttpProvider implements Provider
{
    /**
     * @var string
     */
     ...
     * @return Nominatim
     */
    public static function withOpenStreetMapServer(HttpClient $client, string $userAgent, string $referer = '', array $params = []): self
    {
        return new self($client, 'https://nominatim.openstreetmap.org', $userAgent, $referer, $params);
    }
     ...
     * @param string     $referer   Value of the Referer header
     */
    public function __construct(HttpClient $client, $rootUrl, string $userAgent, string $referer = '', array $params = [])
    {
    ...
    public function geocodeQuery(GeocodeQuery $query): Collection
    {
        ...
        if (count($this->params) > 0) {
            $url .= '&' . http_build_query($this->params, '', '&', PHP_QUERY_RFC3986);
        }
