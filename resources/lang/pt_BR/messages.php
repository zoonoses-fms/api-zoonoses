...
return [
    ...
    "Administrator users can perform any action." => "Usuários com privilégios de Administrador podem executar qualquer acão.",
    "Afghanistan" => "Afeganistão",
    "Aland Islands" => "Ilhas Åland",
    "Albania" => "Albânia",
    "Algeria" => "Argélia",
    "All of the people that are part of this team." => "Todas pessoas que fazem parte dessa equipe.",
    "All resources loaded." => "Todos os recursos carregados.",
    "All rights reserved." => "Todos os direitos reservados.",
    "Already registered?" => "Já registrado?",
    "American Samoa" => "Samoa Americana",
    "An error occured while uploading the file." => "Um erro ocorreu ao subir o arquivo.",
    ...
    "Are you sure you want to force delete the selected resources?" => "Vocẽ tem certeza que deseja forçar a exclusão dos recursos selecionados?",
    ...
    "Are you sure you would like to leave this team?" => "Tem certeza de que deseja sair desta equipe?",
    "Are you sure you would like to remove this person from the team?" => "Tem certeza de que deseja remover esta pessoa da equipe?",
    "Argentina" => "Argentina",
    "Armenia" => "Arménia",
    "Aruba" => "Aruba",
    "Attach" => "Anexar",
    ...
    "Coupon" => "Coupon",
    "Create" => "Criar",
    "Create & Add Another" => "Criar e adicionar",
    ...
    "Detach Selected" => "Separar Os Seleccionados",
    "Details" => "Detalhes",
    "Disable" => "Desativar",
    "Djibouti" => "Jibuti",
    "Do you really want to leave? You have unsaved changes." => "Quer mesmo ir embora? Você tem mudanças não salvas.",
    "Dominica" => "Dominica",
    ...
    "Forbidden" => "Proibido",
    "Force Delete" => "Forçar A Apagar",
    "Force Delete Resource" => "Forçar A Apagar O Recurso",
    "Force Delete Selected" => "Obrigar A Apagar Os Seleccionados",
    ...
    "Great! You have accepted the invitation to join the :team team." => "Muito bom! Aceitou o convite para se juntar à equipa :team.",
    "Greece" => "Grecia",
    ...
    "Sorry! You are not authorized to perform this action." => "Desculpa! Não está autorizado a realizar esta ação.",
    ...
    "Western Sahara" => "Sáara Ocidental",
